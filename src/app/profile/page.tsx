...
export default function ProfilePage() {
    ...
    return (
        <div className="pb-24 pt-6 px-6 md:p-10 max-w-2xl mx-auto">
            ...
            <button onClick={handleLogout} className="w-full bg-rosewood-50 p-5 rounded-3xl flex items-center justify-center gap-4 hover:bg-rosewood-100 transition-colors group shadow-sm border border-rosewood-100">
